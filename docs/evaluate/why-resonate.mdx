...
Distributed Async Await is an open specification that enables a sequential programming model in any language, while providing execution recovery and resume semantics for distributed applications.
...
Resonate components include built-in Deterministic Simulation Testing to ensure they behave as expected in all scenarios.
...
Resonate facilitates simple implementations of a wide range of system-level patterns, including but not limited to:

- Task processing
- Fan-out/fan-in
- Human-in-the-loop | [_See an example_](/get-started/new-project/human-in-the-loop)
- Idempotent operations
- Service discovery | [_See an example_](/get-started/new-project/load-balancing)
- Load balancing | [_See an example_](/get-started/new-project/load-balancing)
