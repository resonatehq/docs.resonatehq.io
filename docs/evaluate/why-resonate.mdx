...
- Task processing
- Fan-out/fan-in
- Human-in-the-loop | [_See an example_](https://github.com/resonatehq-examples/example-human-in-the-loop-py)
- Idempotent operations
- Service discovery | [_See an example_](https://github.com/resonatehq-examples/example-load-balancing-py)
- Load balancing | [_See an example_](https://github.com/resonatehq-examples/example-load-balancing-py)
