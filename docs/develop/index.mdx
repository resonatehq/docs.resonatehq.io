...
For example, you may need to create a promise before invoking a function that will resolve it later.
Or, you need to get a promise to see if it was resolved before doing something else.

#### **Create a promise**

Quick example of creating a promise:
...
Quick example of getting a promise:
