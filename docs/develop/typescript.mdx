...
:::tip
Token-based authentication is recommended for production. See the [Security & Authentication](/operate/security) guide for detailed configuration, best practices, and server setup.
:::
