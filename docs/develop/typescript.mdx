...
Resonate's `.promises.settle()` method allows you to resolve or reject a promise by ID.
...
// Resolve with data
await resonate.promises.settle("promise-id", "resolved", { data: { approved: true } });
