...
<CloneRepoGrid>
  ...
  <CloneRepoCard
    sdk="Python SDK"
    description="A workflow with two leaf functions, run via the Resonate Server."
...
```shell title="Terminal 2 — run the workflow"
uv run main.py
```

You should see the assembled greeting printed after all three durable steps checkpoint.
