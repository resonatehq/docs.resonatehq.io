---
title: Redpanda worker
pageTitle: Redpanda processing worker
description: Start a project that processes Redpanda streams with a durable worker.
keywords:
  - get-started
  - new-project
  - template
...
<img src="/images/example-redpanda-worker-dark.png" alt="Redpanda Worker banner" className="hidden dark:block" />
<img src="/images/example-redpanda-worker-light.png" alt="Redpanda Worker banner" className="block dark:hidden" />
