...
The Python SDK (v0.6.7) currently requires the legacy Resonate server. It is not yet compatible with `resonate dev` (server v0.9.x). See the [Python SDK guide](/docs/develop/python) for legacy server setup.
