...
<img src="/images/banner-develop-dark.png" alt="Develop with Resonate section" className="hidden dark:block" />
<img src="/images/banner-develop-light.png" alt="Develop with Resonate section" className="block dark:hidden" />
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      label: 'Go SDK',
      href: '/develop/go',
      description: 'Install the SDK, register functions, and build durable workflows with Go.',
    },
    {
      type: 'link',
      label: 'Constraints',
