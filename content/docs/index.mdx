...
<img src="/images/resonate-documentation-banner-dark.png" alt="Resonate documentation banner" className="hidden dark:block" />
<img src="/images/resonate-documentation-banner-light.png" alt="Resonate documentation banner" className="block dark:hidden" />
