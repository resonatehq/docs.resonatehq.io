...
![Resonate system architecture](/images/resonate-architecture.png)
...
For the formal treatment of these protocols — promise state transitions, task lifecycle, and message-passing semantics — see the [Distributed Async Await specification](https://distributed-async-await.io/spec).
