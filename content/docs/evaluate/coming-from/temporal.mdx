...
<ThemeImage
  light="/images/temporal-system-arch-light.svg"
  dark="/images/temporal-system-arch-dark.svg"
  alt="Centralized Temporal topology: every Worker connects to a single Temporal Service, sized ahead of time."
/>
...
<ThemeImage
  light="/images/resonate-system-arch-light.svg"
  dark="/images/resonate-system-arch-dark.svg"
  alt="Decentralized Resonate topology: Workers mesh across multiple Resonate Servers, added dynamically as the application scales."
/>
